...
def FN(seed, 
    ...
    q=q0
    eFDR=1
    print('# of original variables:',p0,'# of surrogate variables:',q0)
    ...
    while eFDR>eta:
        train_X,val_X,No,W1,W2,W3,B1,B2,B3,p,q,eFDR,sval=VS(seed, 
                                                            ...
                                                            P,Q,train_Loss,train_Acc,val_Loss,val_Acc,EFDR)
    ...
    return final,No_org,sval_org,P,Q,train_Loss,train_Acc,val_Loss,val_Acc,EFDR